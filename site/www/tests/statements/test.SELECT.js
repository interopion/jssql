(function() {
	...
	QUnit.asyncTest("SELECT (2 + 2);", function(assert) {
		jsSQL(function(API) {
			API.query('SELECT (2 + 2)', function(err, result) {
				assert.ok(!err, err);
	...
	QUnit.asyncTest("Assert that the table can be specified as single name", function(assert) {
		jsSQL(function(API) {
			API.query('select a from t1', function(err, result) {
				assert.ok(!err, err); 
				QUnit.start();
			});
		});
	...
	QUnit.asyncTest("Assert that the table can be specified as {DB}.{tablename}", function(assert) {
		jsSQL(function(API) {
			API.query('select a from unitTestingDB.t1', function(err, result) {
				assert.ok(!err, err); 
				QUnit.start();
			});
		});
	...
	QUnit.asyncTest("Assert that individual table columns can be selected", function(assert) {
		jsSQL(function(API) {
			API.query('select b from t1', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["b"],
					rows : [
	...
	QUnit.asyncTest("Assert that '*' can be used on a single table", function(assert) {
		jsSQL(function(API) {
			API.query('select * from t1', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("Assert that '*' can be used on multiple tables", function(assert) {
		jsSQL(function(API) {
			API.query('select * from t1, t2', function(err, result) {
				assert.ok(!err, err);
	...
	QUnit.asyncTest("LIMIT 2 OFFSET 1", function(assert) {
		jsSQL(function(API) {
			API.query('select * from t1 LIMIT 2 OFFSET 1;', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("LIMIT 2", function(assert) {
		jsSQL(function(API) {
			API.query('select * from t1 LIMIT 2', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("LIMIT 1, 2", function(assert) {
		jsSQL(function(API) {
			API.query('select * from t1 LIMIT 1, 2', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("LIMIT 1, 2 OFFSET 1", function(assert) {
		jsSQL(function(API) {
			API.query('select * from t1 LIMIT 1, 2 OFFSET 1', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("SELECT * FROM t1 ORDER BY a", function(assert) {
		jsSQL(function(API) {
			API.query('SELECT * FROM t1 ORDER BY a', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("SELECT * FROM t1 ORDER BY a ASC", function(assert) {
		jsSQL(function(API) {
			API.query('SELECT * FROM t1 ORDER BY a ASC', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("SELECT * FROM t1 ORDER BY a DESC", function(assert) {
		jsSQL(function(API) {
			API.query('SELECT * FROM t1 ORDER BY a DESC', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("SELECT * FROM t1 ORDER BY b DESC", function(assert) {
		jsSQL(function(API) {
			API.query('SELECT * FROM t1 ORDER BY b DESC', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
	...
	QUnit.asyncTest("Mix an expression with regular columns", function(assert) {
		jsSQL(function(API) {
			API.query('select t1.*, (a + b + (2 + 3)) as sum from t1', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b", "sum"],
					rows : [
	...
	QUnit.asyncTest("Various xpressions", function(assert) {
		jsSQL(function(API) {
			API.query('select (a + b + (2 + 3)) as sum, (Math.PI * 1) from t1', function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["sum", "(Math.PI * 1)"],
					rows : [
	...
	QUnit.asyncTest("SELECT * FROM t1 WHERE a = 'a2'", function(assert) {
		jsSQL(function(API) {
			API.query("SELECT * FROM t1 WHERE a = 'a2'", function(err, result) {
				assert.ok(!err, err);
				assert.deepEqual(result.data, {
					cols : ["a", "b"],
					rows : [
